package com.example.englishplay.view;
...
import com.example.englishplay.utils.DimentionUtil;
/**
 * Created by 小飞侠 on 2018/5/6.
 */

public class CircleButtonView extends android.support.v7.widget.AppCompatImageView {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        if (attrs != null) {
            ...
            text = a.getString(R.styleable.CircleButtonView_cbv_text);
            a.recycle();
        }
